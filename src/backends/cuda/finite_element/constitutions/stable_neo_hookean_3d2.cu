...
#include <finite_element/constitutions/stable_neo_hookean_3d2_function.h>
...
{
class StableNeoHookean3D2 final : public FEM3DConstitution
{
  public:
    // Constitution UID by libuipc specification
    static constexpr U64   ConstitutionUID = 88888;
    ...
    virtual void do_compute_energy(ComputeEnergyInfo& info) override
    {
        ...
        namespace SNH = sym::stable_neo_hookean_3d2;
...
REGISTER_SIM_SYSTEM(StableNeoHookean3D2);
}  // namespace uipc::backend::cuda
